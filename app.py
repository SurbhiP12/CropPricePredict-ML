...
def predict():
    if request.method == 'POST':
        ...
        return render_template('crop_predict.html', prediction_text='Recommended Crop is {}'.format(output))
...
def forecast():
    ...
    return render_template('page2.html',context=context)
...
def crop_profile(name):
    ...
    return render_template('page31.html', context=context)
